...
hala.halaMarid= function(){
     $.ajax({
     url: "https://cuong-dinh.herokuapp.com/halama",
     method : "GET",
     dataType: "json",
            ...
            $("#halaMarid").append(
                ...
                "<div class=;card '>"+
                   ...
                   "<div class='card-body'>"     +                 
                     ...
                     "<strong class='ml-3' onclick='hala.showgia("+ v.id+")'> Giá " + v.dobb +" $ </strong>"+
                    "</span>"+
...
hala.showgia = function (id) {
    $.ajax({
      url: "https://cuong-dinh.herokuapp.com/halama/"+id,
      method : "GET",
      dataType: "json",
      success : function(data){
        var sp={};
        ...
        sp.id="1";
        $.ajax({
          url: "https://cuong-dinh.herokuapp.com/spmua/1",
          method : "PUT",
          dataType: "json",
